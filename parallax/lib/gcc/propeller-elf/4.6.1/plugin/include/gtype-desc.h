...
enum gt_types_enum {
 ...
 gt_ggc_e_20propeller_frame_info,
...
#define ggc_alloc_propeller_frame_info() ((struct propeller_frame_info *)(ggc_internal_alloc_stat (sizeof (struct propeller_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_cleared_propeller_frame_info() ((struct propeller_frame_info *)(ggc_internal_cleared_alloc_stat (sizeof (struct propeller_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_vec_propeller_frame_info(n) ((struct propeller_frame_info *)(ggc_internal_vec_alloc_stat (sizeof (struct propeller_frame_info), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_propeller_frame_info(n) ((struct propeller_frame_info *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct propeller_frame_info), n MEM_STAT_INFO)))
#define ggc_alloc_zone_propeller_frame_info(z) ((struct propeller_frame_info *)(ggc_internal_zone_alloc_stat (z, sizeof (struct propeller_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_propeller_frame_info(z) ((struct propeller_frame_info *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct propeller_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_propeller_frame_info(n, z) ((struct propeller_frame_info *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct propeller_frame_info), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_propeller_frame_info(n, z) ((struct propeller_frame_info *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct propeller_frame_info), n MEM_STAT_INFO)))
...
#define ggc_alloc_zone_target_globals(z) ((struct target_globals *)(ggc_internal_zone_alloc_stat (z, sizeof (struct target_globals) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_target_globals(z) ((struct target_globals *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct target_globals) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_target_globals(n, z) ((struct target_globals *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct target_globals), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_target_globals(n, z) ((struct target_globals *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct target_globals), n MEM_STAT_INFO)))
