...
#endif
#ifdef GENERATOR_FILE
extern int propeller_fcache_enable;
#else
  int x_propeller_fcache_enable;
#define propeller_fcache_enable global_options.x_propeller_fcache_enable
#endif
#ifdef GENERATOR_FILE
...
#define MASK_64BIT_DOUBLES (1 << 0)
#define MASK_CMM (1 << 1)
#define MASK_EXPERIMENTAL (1 << 2)
#define MASK_LMM (1 << 3)
#define MASK_PASM (1 << 4)
#define MASK_OUTPUT_SPINCODE (1 << 5)
#define MASK_XMM (1 << 6)
#define MASK_XMM_SINGLE (1 << 7)
#define MASK_XMM_SPLIT (1 << 8)
#define MASK_XMM_CODE (1 << 9)

#define TARGET_64BIT_DOUBLES ((target_flags & MASK_64BIT_DOUBLES) != 0)
#define TARGET_CMM ((target_flags & MASK_CMM) != 0)
#define TARGET_EXPERIMENTAL ((target_flags & MASK_EXPERIMENTAL) != 0)
#define TARGET_LMM ((target_flags & MASK_LMM) != 0)
#define TARGET_PASM ((target_flags & MASK_PASM) != 0)
#define TARGET_OUTPUT_SPINCODE ((target_flags & MASK_OUTPUT_SPINCODE) != 0)
#define TARGET_XMM ((target_flags & MASK_XMM) != 0)
#define TARGET_XMM_SINGLE ((target_flags & MASK_XMM_SINGLE) != 0)
#define TARGET_XMM_SPLIT ((target_flags & MASK_XMM_SPLIT) != 0)
#define TARGET_XMM_CODE ((target_flags & MASK_XMM_CODE) != 0)
...
enum opt_code
{
  ...
  OPT_m32bit_doubles = 751,                  /* -m32bit-doubles */
  OPT_m64bit_doubles = 752,                  /* -m64bit-doubles */
  OPT_mcmm = 753,                            /* -mcmm */
  OPT_mcog = 754,                            /* -mcog */
  OPT_mexperimental = 755,                   /* -mexperimental */
  OPT_mfcache = 756,                         /* -mfcache */
  OPT_mlmm = 757,                            /* -mlmm */
  OPT_mpasm = 758,                           /* -mpasm */
  OPT_mspin = 759,                           /* -mspin */
  OPT_mxmm = 760,                            /* -mxmm */
  OPT_mxmm_single = 761,                     /* -mxmm-single */
  OPT_mxmm_split = 762,                      /* -mxmm-split */
  OPT_mxmmc = 763,                           /* -mxmmc */
  OPT_n = 764,                               /* -n */
  OPT_no_canonical_prefixes = 765,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 766,               /* -no-integrated-cpp */
  OPT_nodefaultlibs = 767,                   /* -nodefaultlibs */
  OPT_nostartfiles = 768,                    /* -nostartfiles */
  OPT_nostdinc = 769,                        /* -nostdinc */
  OPT_nostdinc__ = 770,                      /* -nostdinc++ */
  OPT_nostdlib = 771,                        /* -nostdlib */
  OPT_o = 772,                               /* -o */
  OPT_p = 773,                               /* -p */
  OPT_pass_exit_codes = 774,                 /* -pass-exit-codes */
  OPT_pedantic = 775,                        /* -pedantic */
  OPT_pedantic_errors = 776,                 /* -pedantic-errors */
  OPT_pg = 777,                              /* -pg */
  OPT_pie = 778,                             /* -pie */
  OPT_pipe = 779,                            /* -pipe */
  OPT_print_file_name_ = 780,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 781,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 782,           /* -print-multi-directory */
  OPT_print_multi_lib = 783,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 784,        /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 785,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 786,                /* -print-prog-name= */
  OPT_print_search_dirs = 787,               /* -print-search-dirs */
  OPT_print_sysroot = 788,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 789,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 790,                           /* -quiet */
  OPT_r = 791,                               /* -r */
  OPT_remap = 792,                           /* -remap */
  OPT_s = 793,                               /* -s */
  OPT_save_temps = 794,                      /* -save-temps */
  OPT_save_temps_ = 795,                     /* -save-temps= */
  OPT_shared = 796,                          /* -shared */
  OPT_shared_libgcc = 797,                   /* -shared-libgcc */
  /* OPT_specs = 798, */                     /* -specs */
  OPT_specs_ = 799,                          /* -specs= */
  OPT_static = 800,                          /* -static */
  OPT_static_libgcc = 801,                   /* -static-libgcc */
  OPT_static_libgfortran = 802,              /* -static-libgfortran */
  OPT_static_libgo = 803,                    /* -static-libgo */
  OPT_static_libstdc__ = 804,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 805, */                 /* -std=c++03 */
  OPT_std_c__0x = 806,                       /* -std=c++0x */
  OPT_std_c__98 = 807,                       /* -std=c++98 */
  OPT_std_c1x = 808,                         /* -std=c1x */
  /* OPT_std_c89 = 809, */                   /* -std=c89 */
  OPT_std_c90 = 810,                         /* -std=c90 */
  OPT_std_c99 = 811,                         /* -std=c99 */
  /* OPT_std_c9x = 812, */                   /* -std=c9x */
  OPT_std_gnu__0x = 813,                     /* -std=gnu++0x */
  OPT_std_gnu__98 = 814,                     /* -std=gnu++98 */
  OPT_std_gnu1x = 815,                       /* -std=gnu1x */
  /* OPT_std_gnu89 = 816, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 817,                       /* -std=gnu90 */
  OPT_std_gnu99 = 818,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 819, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 820, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 821,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 822, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 823, */          /* -std=iso9899:199x */
  OPT_symbolic = 824,                        /* -symbolic */
  OPT_t = 825,                               /* -t */
  OPT_time = 826,                            /* -time */
  OPT_time_ = 827,                           /* -time= */
  OPT_traditional = 828,                     /* -traditional */
  OPT_traditional_cpp = 829,                 /* -traditional-cpp */
  OPT_trigraphs = 830,                       /* -trigraphs */
  OPT_u = 831,                               /* -u */
  OPT_undef = 832,                           /* -undef */
  OPT_v = 833,                               /* -v */
  OPT_version = 834,                         /* -version */
  OPT_w = 835,                               /* -w */
  OPT_wrapper = 836,                         /* -wrapper */
  OPT_x = 837,                               /* -x */
  OPT_z = 838,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
