/* Generated automatically from machmode.def and config/propeller/propeller-modes.def
   by genmodes.  */
...
enum machine_mode
{
  ...
  CCUNSmode,               /* config/propeller/propeller-modes.def:30 */
  CC_Zmode,                /* config/propeller/propeller-modes.def:31 */
  CC_Cmode,                /* config/propeller/propeller-modes.def:32 */
